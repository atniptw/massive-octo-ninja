...
public class Sudoku {
	...
	public static void main(String[] args) {
		/*
		 * ArrayList<CellBlock> blocks = new ArrayList<CellBlock>(); int[][]
		 * board = SudokuGenerator.generateBoard(9); for (int i = 0; i < 9; i++)
		 * { for (int j = 0; j < 9; j++) { CellBlock temp = new CellBlock();
		 * temp.setAnswer(board[i][j]); blocks.add(temp); } }
		 */
